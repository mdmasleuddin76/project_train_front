...
const Gold = () => {
    ...
                                <input
                                    type="number"
                                    placeholder="Purchase Price per ounce"
    ...
                            <p className="text-3xl font-bold mt-2 text-white">{portfolioSummary.totalWeightInGrams.toFixed(2)} ounce</p>
                        </div>
                        <div className="bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-700 transition-all duration-300 hover:border-amber-500 hover:shadow-amber-500/10">
    ...
                                <tr>
                                    {['Purchase Date', 'Quantity (ounce)', 'Purchase Price/ounce', 'Live Price/ounce', 'Current Value', 'Gain/Loss', 'Gain %', 'Action'].map(header => (
